    ...
    <div className="mb-4">
      ...
      <div className="relative">
        <input
          ...
          onChange={(e) => updateFormData("email adress", e.target.value)}
    ...
    <div className="border border-gray-300 rounded-2xl p-6 shadow-md bg-white">
      ...
      <div className="mb-6">
        ...
        <input
          ...
          className="hidden"
          id="cameraUploadID"
         onChange={(e) => updateFormData("file", e.target.value)}
        />
    ...
    <div className="border border-gray-300 rounded-2xl rounded p-6 shadow-sm bg-white relative">
      ...
      <div className="mb-6">
        ...
        <input
          ...
          onChange={(e) => updateFormData("scurity answer", e.target.value)}
